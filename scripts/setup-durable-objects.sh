...
if [ "$1" = "--info" ]; then
    ...
    echo "   • Used by: ar-auth, ar-token, ar-userinfo"
    echo ""
    ...
    echo "   • Used by: ar-token, ar-management"
    echo ""
    echo "4. KeyManager"
    ...
    echo "   • Used by: ar-auth (passkey, magic link, session tokens)"
    echo ""
    ...
    echo "   • Used by: ar-auth (PAR endpoint)"
    echo ""
    echo "8. DPoPJTIStore"
    ...
    echo "   • Used by: ar-management (token revocation)"
    echo ""
    ...
    echo "   • Used by: ar-saml (SAML IdP/SP flows)"
    echo ""
    echo "14. FlowStateStore"
    echo "   • Purpose: Flow Engine runtime state management"
    echo "   • Features: Session state, TTL management, idempotency (requestId dedup)"
    echo "   • Used by: ar-auth (Flow Engine)"
    echo ""
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "📦 Package: @authrim/ar-lib-core"
    echo "   Script name: ar-lib-core"
    echo "   Location: packages/ar-lib-core/"
    echo ""
...
if [ ! -f "packages/ar-lib-core/wrangler.toml" ]; then
    echo "❌ Error: packages/ar-lib-core/wrangler.toml not found"
    echo ""
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
cat packages/ar-lib-core/wrangler.toml
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
(cd packages/ar-lib-core && pnpm run build)
echo "✅ Build complete"
echo ""
...
for i in $(seq 1 $MAX_RETRIES); do
    if (cd packages/ar-lib-core && pnpm run deploy); then
        echo ""
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        ...
        echo "   • Worker name: ar-lib-core"
        echo "   • Durable Objects: 14 (SessionStore, AuthCodeStore, RefreshTokenRotator, KeyManager, ChallengeStore, RateLimiterCounter, PARRequestStore, DPoPJTIStore, TokenRevocationStore, DeviceCodeStore, CIBARequestStore, VersionManager, SAMLRequestStore, FlowStateStore)"
        echo ""
        ...
        echo "  3. Verify deployment: curl https://ar-lib-core.<subdomain>.workers.dev/"
        echo ""
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        exit 0
    else
        if [ $i -lt $MAX_RETRIES ]; then
            ...
            echo "  4. Try deploying manually: cd packages/ar-lib-core && pnpm run deploy"
            echo ""
