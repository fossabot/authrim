...
<!-- Create Dialog -->
<Modal open={showCreateDialog} onClose={closeCreateDialog} title="Add Role Assignment Rule">
	{#if createError}
...
>
	...
	<div class="form-group">
		...
		<textarea id="test-claims" class="form-textarea" bind:value={testClaims} rows="6"></textarea>
