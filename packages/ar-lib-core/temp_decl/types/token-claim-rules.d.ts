 ...
 */
export declare const RESERVED_CLAIMS: readonly [
  'sub',
  'iss',
  'aud',
  'exp',
 ...
 */
export declare const PII_CLAIM_PATTERNS: readonly [
  'email',
  'name',
  'phone',
  'address',
 ...
 */
export declare const DEFAULT_TOKEN_EMBEDDING_LIMITS: TokenEmbeddingLimits;
/**
...
//# sourceMappingURL=token-claim-rules.d.ts.map
