 ...
 */
export declare const DEFAULT_ID_TOKEN_CLAIMS: IDTokenClaimKey[];
export declare const DEFAULT_ACCESS_TOKEN_CLAIMS: AccessTokenClaimKey[];
/**
 ...
 */
export declare const DEFAULT_ROLE_IDS: {
  readonly SYSTEM_ADMIN: 'role_system_admin';
  readonly DISTRIBUTOR_ADMIN: 'role_distributor_admin';
  readonly ORG_ADMIN: 'role_org_admin';
  readonly END_USER: 'role_end_user';
};
