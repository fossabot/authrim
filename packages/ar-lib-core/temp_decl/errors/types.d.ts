 ...
 */
export type ErrorSecurityLevel = 'public' | 'masked' | 'internal';
/**
 ...
 */
export declare const SECURITY_TRACKED_ERRORS: readonly [
  'invalid_client',
  'invalid_grant',
  'unauthorized_client',
  'access_denied',
 ...
 */
export declare const OIDC_CORE_ENDPOINTS: readonly [
  '/authorize',
  '/token',
  '/userinfo',
  '/introspect',
