 ...
 */
export type CheckResolutionMethod = 'direct' | 'computed' | 'cache' | 'closure';
/**
 * Batch check request
 */
...
export declare const REBAC_CACHE_PREFIX = 'rebac:check:';
/** Closure table batch size */
export declare const DEFAULT_CLOSURE_BATCH_SIZE = 100;
