...
export const OAUTH_SETTINGS_META: Record<keyof OAuthSettings, SettingMeta> = {
  ...
  'oauth.refresh_token_rotation': {
    ...
    type: 'boolean',
    default: true,
    envKey: 'REFRESH_TOKEN_ROTATION_ENABLED',
  ...
  'oauth.userinfo_require_openid': {
    ...
    type: 'boolean',
    default: true,
    envKey: 'USERINFO_REQUIRE_OPENID_SCOPE',
  ...
  'oauth.error_description': {
    ...
    type: 'boolean',
    default: true,
    envKey: 'ERROR_DESCRIPTION_ENABLED',
  ...
  'oauth.iss_response_param': {
    ...
    type: 'boolean',
    default: true,
    envKey: 'ISS_RESPONSE_PARAM_ENABLED',
